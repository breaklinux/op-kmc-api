...
class baseHttpApi():
    ...
    1.初始化参数
    """
    def __init__(self, method, url, header=None, body=None, timeout=5,):
        self.url = url
        self.header = header
        self.body = body
    ...
    def sendPost(self):
        ...
        """
        result = self.ifHeaderContentType(header, body)
    ...
    def sendDelete(self):
        ...
        3.返回结果
        """
        result = self.ifHeaderContentType(self.header, self.body)
        if not result.get("body") is None:
